<x-app-sidebar>
    @php
        ...
        $isStudentProfile = $student->role === 'STUDENT';
        $roleLabels = [
            'STUDENT' => 'Studente',
            'TEACHER' => 'Docente',
        ...
        $roleLabel = $roleLabels[$student->role] ?? $student->role;
    @endphp
    ...
    <div class="flex flex-col gap-6">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-sm text-slate-500">{{ $isStudentProfile ? 'Profilo studente' : 'Profilo utente' }}</p>
            </div>
        ...
        <div class="grid grid-cols-1 gap-4 lg:grid-cols-2">
            <div class="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
                ...
                <div class="mt-3 space-y-2 text-sm text-slate-700">
                    ...
                    <div><span class="font-medium text-slate-900">Ruolo:</span> {{ $roleLabel }}</div>
