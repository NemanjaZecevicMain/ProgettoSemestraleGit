                    ...
                    <div class="rounded-xl border border-slate-200 bg-white p-4">
                        ...
                        @elseif ($absence->status === 'WAITING_SIGNATURE')
                            <p class="mt-2 text-sm text-slate-600">
                                Crea un link da inviare al firmatario. Per motivi di sicurezza il link viene mostrato solo al momento della creazione.
                            </p>
                            ...
                            @if (session('signature_link'))
                                <div class="mt-4 rounded-lg border border-blue-100 bg-blue-50 px-3 py-2 text-sm text-blue-900">
                                    <div class="text-xs uppercase tracking-wider text-blue-700">Link generato</div>
                                    <div class="mt-2 break-all font-medium">{{ session('signature_link') }}</div>
                                </div>
                            @endif
