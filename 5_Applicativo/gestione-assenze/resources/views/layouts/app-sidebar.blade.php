...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="bg-slate-50 text-slate-900 antialiased">
        <div class="min-h-screen flex flex-col lg:flex-row">
            <aside class="w-full lg:w-64 lg:min-w-64 lg:max-w-64 bg-blue-900 text-blue-50 border-b lg:border-b-0 lg:border-r border-blue-800">
                <div class="px-6 py-5 border-b border-blue-800">
                    <div class="text-lg font-semibold text-white">CPT Lugano-Trevano</div>
                    <div class="text-sm text-blue-200">Istituto scolastico</div>
                </div>

                <nav class="px-3 py-4 space-y-1">
                    <a href="{{ route('dashboard') }}" class="group flex items-center gap-3 rounded-lg px-3 py-2 text-sm font-medium text-blue-100 hover:bg-blue-800/70 hover:text-white">
                    ...
                    <a href="{{ route('settings.index') }}" class="group flex items-center gap-3 rounded-lg px-3 py-2 text-sm font-medium bg-blue-800/80 text-white border-l-4 border-blue-300">
                        <svg class="h-5 w-5 text-blue-200" viewBox="0 0 24 24" fill="none">
